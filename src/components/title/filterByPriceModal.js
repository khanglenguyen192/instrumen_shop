                        ...
                        <div className="container filter-price-modal">
                            <div className="row">
                                <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                                    {priceTag.map((item) => {
                                        return (<button className="btn btn-outline-secondary" onClick={() => { value.filterByPrice(item.index, value.productType.data); value.setFilterByPrice() }}>{item.name}</button>)
                                    })}
                                </div>
                            </div>
                        </div>
